...
/*   Updated: 2022/09/26 05:30:00 by ababouel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    rotation(t_vector *vf, double angle)
{
    ...
    v = vf->x;
    vf->x = vf->x * cos(angle * (3.1348/180)) - vf->y * sin(angle * (3.1348/180));
    vf->y = vf->y * cos(angle * (3.1348/180)) + v * sin(angle * (3.1348/180)); 
}